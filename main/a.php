...
$(document).ready(function(){
	//생년월일 정보 가져오기
    var sex = $_SESSION('sex');
	var birth = $("#birth").val();
	//ajax 통신 - url로 호출해서 데이터 불러오기
	$.ajax({
		url:'https://m.search.naver.com/p/csearch/dcontent/external_api/json_todayunse_v2.naver?_callback=window.__jindo2_callback._fortune_my_0&gender=f&birth='+birth+'&solarCal=solar&time='
	}).done(function(json){
